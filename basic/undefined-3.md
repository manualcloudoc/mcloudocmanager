...
관리자웹 **서버 관리** 메뉴에서는 각 회사별 서버 구성에 맞게 파티션을 추가하여 관리합니다. 서버 관리에 앞서 [**스토리지 마운트(Storage Mount) 방법**](../system/undefined-1/storage-mount.md), [**시스템 구성별 파티션 정보 등록 방법**](../system/undefined-1/undefined-2.md)을 확인하여 주시기 바랍니다. 해당 아티클에서 파티션 개념 및 시스템 구성을 참고하실 수 있습니다.
