...
### <mark style="color:$primary;">문서보안등급 구조 설정하기</mark>
...
* **편입 등급 선택**:등급이 보안등급 목록에서 삭제되어 선택한 등급으로 편입됩니다.해당 등급으로 설정되어 있던 문서의 보안등급은 그대로 보존되며, 이후 편입된 등급으로 취급됩니다.
* **등급 삭제**:등급이 보안등급 목록에서 완전히 삭제되며,해당 등급으로 설정되어 있던 문서는 이후 일반 문서로 취급됩니다.
...
### <mark style="color:$primary;">문서보안등급 구조 설정 이력 보기</mark>
...
> - **추가**: 보안등급을 추가한 경우
> - **수정**: 보안등급의 **등급명, 메모**를 변경한 경우
> - **삭제**: 보안등급 삭제 시 등급을 완전히 삭제한 경우
