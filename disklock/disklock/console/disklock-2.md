...
3. 정책 아이템의 현재 설정 정보를 보여주는 **정책 아이템 설정** 화면이 나타납니다. [**정책 아이템 생성하기**](disklock-2.md)를 참고하여 수정이 필요한 항목들을 다시 설정한 후 **확인**을 클릭합니다.&#x20;
4. 도구모음의 **적용**을 클릭하여 정책의 변경 사항을 서버에 적용합니다.\
   &#x20;
