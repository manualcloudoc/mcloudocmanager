...
<img src="../.gitbook/assets/image (220).png" alt="" data-size="line"> **1.영업본부** 폴더 등 표에서 <img src="../.gitbook/assets/image (104).png" alt="" data-size="line"> 표시가 된 폴더에서는 권한을 새로 설정해야 합니다.
...
<img src="../.gitbook/assets/image (221).png" alt="" data-size="line"> **1.견적사 자료** 등 표에서 회색 음영으로 표시된 폴더에서는 권한을 별도로 설정할 필요가 없으며, 상위 폴더에서 상속된 권한이 그대로 적용됩니다.
